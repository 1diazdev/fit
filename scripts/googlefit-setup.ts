...
const redirectUri = process.env.GOOGLE_FIT_REDIRECT_URI || 'http://localhost:3000/callback';
...
try {
  ...
  console.log('   - The authorization code is single-use - generate a new one if needed\n');
